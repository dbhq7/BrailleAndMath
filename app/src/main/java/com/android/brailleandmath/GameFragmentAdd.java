 ...
 * GameFragmentAdd.java is a fragment class that inflates the view of the addition portion of the game
 * Stores equations for addition questions in varaibles
...
public class GameFragmentAdd extends Fragment {
    ...
    private void showCorrectToast(){
        Toast toast = Toast.makeText(getActivity(), R.string.correct_toast, Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.BOTTOM, 0, 0);
        toast.show();
    }

    private void showIncorrectToast(){
        Toast toast1 = Toast.makeText(getActivity(), R.string.incorrect_toast, Toast.LENGTH_SHORT);
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.game_fragment_add, container, false);
        ...
        flag5 = false;
        flag6 = false;
        draw1 = R.drawable.oneplusfive;
        draw2 = R.drawable.threeplusfour;
        draw3 = R.drawable.oneplustwo;
        draw4 = R.drawable.sevenplustwo;
        draw5 = R.drawable.fiveplusthree;
        drawcounter = 0;
        correctans = 0;
        incorrectans = 0;
        ...
        questionAdd = (ImageView)v.findViewById(R.id.equation);
        questionAdd.setImageResource(draw1);
        questionAdd.setContentDescription("What does one plus five equal");
        ...
        nextadd = (Button) v.findViewById(R.id.nextbuttonadd);
            ...
            public void onClick(View v) {
                switch(drawcounter) {
                    case 0:
                        ...
                        drawcounter++;
                        questionAdd.setImageResource(draw2);
                        questionAdd.setContentDescription("What does three plus four equal");
                        break;
                    case 1:
                        if (flag1 && flag2 && !flag3 && flag4 && flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionAdd.setImageResource(draw3);
                        questionAdd.setContentDescription("What does one plus two equal");
                        break;
                    case 2:
                        if (flag1 && !flag2 && !flag3 && flag4 && !flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionAdd.setImageResource(draw4);
                        questionAdd.setContentDescription("What does seven plus two equal");
                        break;
                    case 3:
                        if (!flag1 && flag2 && !flag3 && flag4 && !flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionAdd.setImageResource(draw5);
                        questionAdd.setContentDescription("What does five plus three equal");
                        break;
                    case 4:
                        if (flag1 && flag2 && !flag3 && !flag4 && flag5 && !flag6) {
                            showCorrectToast();
