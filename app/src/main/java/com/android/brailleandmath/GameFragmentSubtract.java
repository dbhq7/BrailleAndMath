 ...
 * GameFragmentSubtract.java is a fragment class that inflates the view of the subtraction portion of the game
 * Stores equations for subtraction questions in varaibles
...
public class GameFragmentSubtract extends Fragment {
    ...
    private Button nextsub;
    private ImageView t1, t2, t3, t4, t5, t6;
    private ImageView questionSubtract;
    ...
    /**
     * @param inflater - inflates subtraction game fragment layout
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.game_fragment_subtract, container, false);
        ...
        flag5 = false;
        flag6 = false;
        draw1 = R.drawable.fiveminusone;
        draw2 = R.drawable.nineminusfour;
        draw3 = R.drawable.eightminusseven;
        draw4 = R.drawable.sixminusthree;
        draw5 = R.drawable.twominuszero;
        drawcounter =0;
        correctans = 0;
        incorrectans = 0;
        ...
        questionSubtract = (ImageView)v.findViewById(R.id.equation3);
        questionSubtract.setImageResource(draw1);
        questionSubtract.setContentDescription("What does five minus one equal");
        ...
        nextsub = (Button) v.findViewById(R.id.nextbuttonsub);
            ...
            public void onClick(View v) {
                switch(drawcounter) {
                    ...
                    case 0:
                        ...
                        drawcounter++;
                        questionSubtract.setImageResource(draw2);
                        questionSubtract.setContentDescription("What does nine minus four equal");
                        break;
                    case 1:
                        if (flag1 && !flag2 && !flag3 && !flag4 && flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionSubtract.setImageResource(draw3);
                        questionSubtract.setContentDescription("What does eight minus seven equal");
                        break;
                    case 2:
                        if (flag1 && !flag2 && !flag3 && !flag4 && !flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionSubtract.setImageResource(draw4);
                        questionSubtract.setContentDescription("What does six minus three equal");
                        break;
                    case 3:
                        if (flag1 && !flag2 && !flag3 && flag4 && !flag5 && !flag6) {
                            showCorrectToast();
                        ...
                        drawcounter++;
                        questionSubtract.setImageResource(draw5);
                        questionSubtract.setContentDescription("What does two minus zero equal");
                        break;
                    case 4:
                        if (flag1 && flag2 && !flag3 && !flag4 && !flag5 && !flag6) {
                            showCorrectToast();
